                    ...
                    <div className="flex gap-5 text-[14px] justify-center md:justify-start">
                        {iconsTab.map(({ icon }, index) => {
                            return (
                                <div
                                    key={index}
                                    className="hover:bg-white hover:text-black dark:hover:bg-white dark:hover:text-black rounded-full p-2 cursor-pointer border border-gray-300 dark:border-white"
